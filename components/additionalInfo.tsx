...
const LinkWrapper = ({ link }: { link: exLink }) => {
	return (
		<div className="items-center text-center p-1.5 m-2 bg-black rounded-lg border-2 border-slate-700 border-solid bg-[#62a590] cursor-pointer hover:border-blue-300">
